...
import org.elasticsoftware.elasticactors.core.actors.ActorDelegate;
 ...
 */
public final class HttpResponseDelegate<T> extends ActorDelegate<T> {
    private final CompletableFuture<T> future;
    private final Class<T> responseType;

    public HttpResponseDelegate(CompletableFuture<T> future, Class<T> responseType) {
        this.future = future;
