...
public final class SubscriptionMessageSerializer implements MessageSerializer<SubscriptionMessage> {
    @Override
    public ByteBuffer serialize(SubscriptionMessage message) throws IOException {
        Reactivestreams.SubscriptionMessage.Builder builder = Reactivestreams.SubscriptionMessage.newBuilder();
