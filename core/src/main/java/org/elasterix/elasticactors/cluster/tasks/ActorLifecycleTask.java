...
public abstract class ActorLifecycleTask implements ThreadBoundRunnable<String> {
    ...
    public final void run() {
        ...
        try {
            doInActorContext(actorSystem, receiver, receiverRef);
        } catch (Exception e) {
    ...
    protected abstract void doInActorContext(InternalActorSystem actorSystem, ElasticActor receiver, ActorRef receiverRef);
