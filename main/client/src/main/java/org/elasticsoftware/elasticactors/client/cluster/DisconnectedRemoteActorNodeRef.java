...
final class DisconnectedRemoteActorNodeRef extends BaseDisconnectedActorRef {

    private final String nodeId;

    DisconnectedRemoteActorNodeRef(
            String clusterName,
        ...
        super(
                actorId,
                clusterName,
                generateRefSpec(clusterName, actorSystemName, nodeId, actorId),
                actorSystemName);
        this.nodeId = nodeId;
    }
    ...
    protected String getExceptionMessage() {
        return format(
                "Cannot reach Remote Actor Node %s in cluster [%s] using a Remote Actor Reference",
                nodeId,
                clusterName);
    }
}
