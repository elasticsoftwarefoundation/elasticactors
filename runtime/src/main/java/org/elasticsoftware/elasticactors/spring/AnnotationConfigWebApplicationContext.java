 ...
 *
 * <p>Unlike {@link org.springframework.web.context.support.XmlWebApplicationContext}, no default configuration class locations
...
public class AnnotationConfigWebApplicationContext extends AbstractRefreshableWebApplicationContext {
    ...
    public void addIncludeFilters(TypeFilter... typeFilters) {
        this.includeFilters.addAll(Arrays.asList(typeFilters));
    }
