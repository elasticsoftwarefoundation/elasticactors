 ...
 * <pre>
 * {@code
 * $ java -cp target/streams-examples-3.3.0-standalone.jar io.confluent.examples.streams.WordCountLambdaExampleTest
 * }</pre>
...
public class WordCountLambdaExampleTest {
    ...
    @Test
    public void testWordCountLambda() throws Exception {
        final String bootstrapServers = "192.168.99.100:31092";
