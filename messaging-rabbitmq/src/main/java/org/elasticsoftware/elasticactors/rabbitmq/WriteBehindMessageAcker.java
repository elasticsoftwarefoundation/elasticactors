...
public final class WriteBehindMessageAcker implements MessageAcker {
    private static final Logger logger = Logger.getLogger(WriteBehindMessageAcker.class);
    ...
    public WriteBehindMessageAcker(Channel consumerChannel) {
        ...
        this.disruptor = new Disruptor<>(new AckEventFactory(), 1024, Executors.newCachedThreadPool(new DaemonThreadFactory("RABBITMQ-MESSAGE_ACKER")));
